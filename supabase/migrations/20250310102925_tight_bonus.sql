/*
  ...
  1. Changes
    ...
    - Add foreign key relationship between assignments and profiles
...
-- Add foreign key relationship between event_contribution_assignments and profiles
ALTER TABLE event_contribution_assignments
DROP CONSTRAINT IF EXISTS event_contribution_assignments_user_id_fkey,
ADD CONSTRAINT event_contribution_assignments_user_id_fkey 
